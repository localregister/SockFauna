...
public class BlazaBehaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _vehicleHoldPoint = gameObject.transform.SearchChild("SeamothAttach_end").transform;
    ...
    private void GrabVehicle(Vehicle vehicle, VehicleType vehicleType)
    {
        ...
        SafeAnimator.SetBool(creature.GetAnimator(), "vehicle_attack", true);
        SafeAnimator.SetBool(creature.GetAnimator(), "vehicle_attack", true);
    ...
    public void ReleaseVehicle()
    {
        ...
        SafeAnimator.SetBool(creature.GetAnimator(), "vehicle_attack", false);
        SafeAnimator.SetBool(creature.GetAnimator(), "vehicle_attack", false);
